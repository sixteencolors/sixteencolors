...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{SIXTEENCOLORS_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{SIXTEENCOLORS_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
sixteencolors_server.pl - Catalyst Testserver

=head1 SYNOPSIS

sixteencolors_server.pl [options]
